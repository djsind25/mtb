...
export function LogoMark({ size = 26 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" style={{ flexShrink: 0 }} aria-label="MyTrashBid">
      ...
      <rect x="5" y="15" width="34" height="6" rx="1.5" fill={C.pineDeep} />
      <path d="M8 21 H36 L33.5 39 H10.5 Z" fill={C.pine} />
      <circle cx="14" cy="41.5" r="2.4" fill={C.pineDeep} />
      <circle cx="30" cy="41.5" r="2.4" fill={C.pineDeep} />
      <circle cx="22" cy="30" r="7" fill="#fff" />
      <path d="M18.5 30 L21 32.5 L26 27" stroke={C.pine} strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    </svg>
  );
}
