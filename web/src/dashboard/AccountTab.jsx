  ...
  return (
    <div style={{ display: "grid", gap: 24 }}>
      ...
      <section>
        ...
        <Field label="New passcode" value={newPassword} onChange={setNewPassword} type="password" placeholder="At least 8 characters" checklist={passcodeChecklist(newPassword)} />
