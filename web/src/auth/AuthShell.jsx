import { C, serif, sans, SHADOW_MD } from "../theme";
...
export function AuthShell({ title, subtitle, onBack, children }) {
  return (
    <div style={{ minHeight: "100vh", background: C.paper, display: "flex", alignItems: "center", justifyContent: "center", padding: 20, fontFamily: sans }}>
      <div style={{ width: "100%", maxWidth: 400, background: C.paper, borderRadius: 20, padding: 28, border: `1px solid ${C.line}`, boxShadow: SHADOW_MD }}>
        ...
        <div style={{ fontFamily: serif, fontSize: 22, fontWeight: 800, color: C.pineDeep, marginBottom: 2 }}>{title}</div>
