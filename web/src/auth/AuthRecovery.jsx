  ...
  return (
    <AuthShell title="Set a new passcode" subtitle="You clicked a passcode reset link" onBack={onBack}>
      {sessionState === "checking" || needsStepUp === null ? (
        ...
        <>
          <Field label="New passcode" value={passcode} onChange={setPasscode} type="password" placeholder="At least 8 characters" required checklist={passcodeChecklist(passcode)} />
